...
tags:
  ...
  - azure-devops
  - runners
title: dotnet_azure_agent.ps1
---
*This article will tell you how to use powershell script below, why it creates and release. Go check it in article :BoBxsRightArrow::BoBxsRightArrow: [Setup the virtual machine Linux and Windows for Agents and Azure-Pipelines](https://hackmd.io/@XeusNguyen/S1BrSRPW6)*
```powershell
