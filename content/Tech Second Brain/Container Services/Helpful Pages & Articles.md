...
## Kubernetes API Gateway / Ingress Controller
...
- [emissary-apigateway](https://www.getambassador.io/products/api-gateway): An Envoy-powered Open Source API Gateway
