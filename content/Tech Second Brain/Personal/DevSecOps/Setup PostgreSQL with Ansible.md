...
- Running the ansible for setup postgresql and configure your postgresql. This configuration will put inside `YAML` style and refer with this article to deployment via `ansible`
	...
	1. [Deploy PostgreSQL via Docker and Ansible](PostgreSQL%20Self-hosted%20in%20Docker%20by%20Ansible.md)
	2. [Deploy PostgreSQL in Host with Ansible](PostgreSQL%20Self-hosted%20in%20VM%20by%20Ansible.md)
