...
- [Packer](https://github.com/hashicorp/packer): The official repository
- [Packer Integration](https://developer.hashicorp.com/packer/integrations): A curated collection of official, partner, and community Packer Integrations.
## Articles

- [AWS - Building Amazon Machine Images (AMIs) for EC2 Mac instances with Packer](https://aws.amazon.com/blogs/compute/building-amazon-machine-images-amis-for-ec2-mac-instances-with-packer/)
- [Youtube - HashiCorp Packer Tutorial: Building Custom Images for AWS, Azure, and Docker](https://www.youtube.com/watch?v=OmQRpi3CSjU)
- [DevOpsCube - Packer Tutorial For Beginners - Automate AMI Creation](https://devopscube.com/packer-tutorial-for-beginners/)

# OS Provisioning Collections
