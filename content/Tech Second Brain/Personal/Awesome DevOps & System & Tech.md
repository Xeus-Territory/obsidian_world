...
- [Google](https://github.com/google): Google ❤️ Open Source 🌟 **(Recommended)**
...
- [Hashicorp](https://github.com/hashicorp): Consistent workflows to provision, secure, connect, and run any infrastructure for any application. 🌟 **(Recommended)**
...
- [Netflix](https://github.com/Netflix): Netflix Open Source Platform 🌟 **(Recommended)**
...
- [Tencent](https://github.com/Tencent) : Tencent Open Source Community 🌟 **(Recommended)**
...
- [Christian Lempa](https://www.youtube.com/@christianlempa): Selfhost sharing, supercool with containerization platform 🌟 **(Recommended)**
- [CNCF (Cloud Native Computing Foundation)](https://www.youtube.com/@cncf): Cloud Native powered by CNCF  🌟 **(Recommended)**
...
- [DevOps Toolkit](https://www.youtube.com/@DevOpsToolkit/videos): Help you **learn the tools and the processes** that you should be using and applying in your day-to-day job 🌟 **(Recommended)**
...
- [Techno Tim](https://www.youtube.com/@TechnoTim/videos): Selfhost sharing and multiple technologies 🌟 **(Recommended)**
...
- [The Linux Foundation](https://www.youtube.com/@LinuxfoundationOrg/featured): A nonprofit consortium dedicated to fostering the growth of Linux and collaborative software development 🌟 **(Recommended)**
